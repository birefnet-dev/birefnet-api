...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/bria/rmbg-2.0?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-badge&utm_term=tier-a)
...
> **Try it now:** [https://synexa.ai/explore/bria/rmbg-2.0](https://synexa.ai/explore/bria/rmbg-2.0?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-top&utm_term=tier-a) — the hosted model behind this client. New accounts get a free trial credit.
...
Then set your API key (create one at [synexa.ai](https://synexa.ai?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-apikey&utm_term=tier-a)):
...
|---|---|---|---|
| [`bria/rmbg-2.0`](https://synexa.ai/explore/bria/rmbg-2.0?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-models&utm_term=tier-a) | image-to-image | RMBG 2.0 cuts the subject out of an image and returns it on a transparent background. | $0.018 |
| [`supavisual/remove-background`](https://synexa.ai/explore/supavisual/remove-background?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-models&utm_term=tier-a) | image-to-image | Remove the background from an image, producing a clean cutout with a transparent background. | $0.01 |
| [`danielgatis/rembg`](https://synexa.ai/explore/danielgatis/rembg?utm_source=github&utm_medium=ugc&utm_campaign=birefnet-dev&utm_content=readme-models&utm_term=tier-a) | image-to-image | A fast, no-frills background remover that returns the subject on a transparent background. | $0.01 |
